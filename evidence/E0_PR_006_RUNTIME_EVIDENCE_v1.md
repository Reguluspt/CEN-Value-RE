...
**Tested HEAD:** `9550631e2815e0a41f2619e0a944ccf3f9fa8190`
**GitHub Actions run:** `31957763104`
**Python:** `3.11.15`
**Flask:** `3.1.1`
...
- unauthenticated protected health rejected: PASS
- stale launch rejected: PASS
- invalid bearer rejected: PASS
- non-loopback remote request rejected: PASS
- protected health accepts current launch credential: PASS
