...
_N08_SUBJECT_BINDINGS = (
    ...
    _binding("Nhập liệu!I31", "subject.noncompliant_unit_price", WorkbookValueKind.DECIMAL),
    _binding("Nhập liệu!F38", "subject.compliant_area_m2", WorkbookValueKind.DECIMAL),
    ...
    _binding("Nhập liệu!H47", "subject.depth", WorkbookValueKind.DECIMAL),
...
_N08_COMPARABLE_BINDINGS = (
    ...
    _binding("Phieu TTTT!B18", "comparable.1.negotiated_price", WorkbookValueKind.DECIMAL),
    _binding("Phieu TTTT!B19", "comparable.1.transaction_success_factor", WorkbookValueKind.FRACTION),
    _binding("Phieu TTTT!D29", "comparable.1.area_m2", WorkbookValueKind.DECIMAL),
    _binding("Phieu TTTT!D34", "comparable.1.frontage", WorkbookValueKind.DECIMAL),
    _binding("Phieu TTTT!D35", "comparable.1.depth", WorkbookValueKind.DECIMAL),
    ...
    _binding("Phieu TTTT!G18", "comparable.2.negotiated_price", WorkbookValueKind.DECIMAL),
    _binding("Phieu TTTT!G19", "comparable.2.transaction_success_factor", WorkbookValueKind.FRACTION),
    _binding("Phieu TTTT!I29", "comparable.2.area_m2", WorkbookValueKind.DECIMAL),
    ...
    _binding("Phieu TTTT!L18", "comparable.3.negotiated_price", WorkbookValueKind.DECIMAL),
    _binding("Phieu TTTT!L19", "comparable.3.transaction_success_factor", WorkbookValueKind.FRACTION),
    _binding("Phieu TTTT!N29", "comparable.3.area_m2", WorkbookValueKind.DECIMAL),
    _binding("Phieu TTTT!N34", "comparable.3.frontage", WorkbookValueKind.DECIMAL),
    _binding("Phieu TTTT!N35", "comparable.3.depth", WorkbookValueKind.DECIMAL),
    _binding("Phieu TTTT!N38", "comparable.3.shape", WorkbookValueKind.TEXT),
    _binding("Phieu TTTT!L55", "comparable.3.building_area_m2", WorkbookValueKind.DECIMAL),
