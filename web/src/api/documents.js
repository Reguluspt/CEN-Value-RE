...
export const generateDocuments = (caseId, paymentMethod, templateGroupId) =>
  client.post(`/cases/${caseId}/documents/generate`, {
    organization_contract_payment_method: paymentMethod,
    template_group_id: templateGroupId,
  });

export const getDocumentTemplatePreference = (caseId) =>
  client.get(`/cases/${caseId}/documents/template-preference`);
...
export const updateDeliveryContact = (contactId, payload) =>
  client.put(`/delivery/contacts/${contactId}`, payload);
