...
export default function KpiCards({ stats = {}, periodLabel = 'cả năm' }) {
  const {
    year_projected = 0,
    year_paid = 0,
    year_unpaid = 0,
  ...
  return (
    <Row gutter={[16, 16]} style={{ marginBottom: 20 }}>
      ...
      <Col xs={24} sm={12} md={6}>
        <div style={cardStyle}>
          <div style={labelStyle}>Doanh thu dự kiến {periodLabel}</div>
      ...
      <Col xs={24} sm={12} md={6}>
        <div style={cardStyle}>
          <div style={labelStyle}>Đã thanh toán {periodLabel}</div>
          <div style={valueStyle}>
      ...
      <Col xs={24} sm={12} md={6}>
        <div style={cardStyle}>
          <div style={labelStyle}>Công nợ tồn {periodLabel}</div>
          <div style={valueStyle}>
