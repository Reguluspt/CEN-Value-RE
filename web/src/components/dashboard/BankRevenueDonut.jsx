...
export default function BankRevenueDonut({ data = [], periodLabel = '' }) {
const colors = [
    "#007f7a",
    "#2aa0a4",
    "#d99a55",
  ...
  return (
    ...
    >
      ...
      <div style={{ fontSize: 12, color: '#64748b', marginBottom: 20 }}>
        Tổng doanh thu dự kiến {periodLabel || 'theo bộ lọc hiện tại'}.
      </div>

      {total <= 0 ? (
        <div style={{ textAlign: 'center', padding: '40px 0', color: '#64748b' }}>
          Chưa có dữ liệu doanh thu theo ngân hàng {periodLabel || 'đang chọn'}.
        </div>
      ) : (
