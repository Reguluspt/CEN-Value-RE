...
import { toMailPreviewText } from './soboMailPreview';
...
export default function SoboTable({
  ...
  const { getResizableProps } = useResizableColumns('sobo_list_v2', {
    id_date: 120,
    info: 450,
    response_content: 320,
    status_time: 130,
    actions: 220
  }, {
    id_date: { min: 100, max: 160 },
    info: { min: 320, max: 520 },
    response_content: { min: 250, max: 400 },
    status_time: { min: 120, max: 160 },
    actions: { min: 220, max: 260 }
  });
  ...
  const columns = [
    ...
    },
    {
      ...
      render: (_, record) => {
        ...
        const previewText = toMailPreviewText(content);
        ...
        return (
          ...
          >
            {/* Bản xem trước văn bản được giới hạn 5 dòng */}
