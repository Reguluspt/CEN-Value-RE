...
import logoImg from '../assets/cenvalue-logo.png';
...
export default function Layout({ children }) {
  ...
  const navItems = isGuest
    ...
    { path: '/sobo', label: 'Sơ bộ', icon: <FileTextOutlined style={{ fontSize: '16px' }} /> },
        { path: '/directories', label: 'Danh bạ', icon: <ContactsOutlined style={{ fontSize: '16px' }} /> },
  ...
  return (
    <AntLayout style={{ minHeight: '100vh', backgroundColor: '#f4faf9' }}>
      ...
      {/* Main Content Area */}
      <Content className="layout-content" style={{ marginTop: 64, padding: '24px 20px', minHeight: 'calc(100vh - 64px - 70px)' }}>
