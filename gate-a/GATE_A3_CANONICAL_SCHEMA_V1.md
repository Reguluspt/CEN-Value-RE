# CenValue Manager RE — Gate A.3 Canonical Schema v1

**Date:** 2026-08-15
**Status:** CORE CONTRACT FROZEN; workbook-specific field registry remains extensible
...
- All canonical `*_pct` values use fractional scale (`1` = 100%, `0.05` = 5%) unless an explicitly named presentation/legacy field states otherwise; adapters alone convert to/from percentage-point display.
